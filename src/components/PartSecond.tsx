  ...
  `}
        >
            <div className="_main flex flex-col w-full h-full bg-white order-1 md:order-2 print:order-2">
                ...
                <Job jobExperience={content.jobs[2]} _className="hidden print:flex border-t-0 z-10"/>
                <Job jobExperience={content.jobs[3]} _className="hidden print:flex z-10"/>
            ...
            <div className="_sidebar flex flex-col w-full h-full z-10 bg-gray-500 order-2 md:order-1 print:order-1">
                ...
                <div className="mb:h-full mb-9 ">
                    <Liner text={"Contacts"} _className="px-3.5 bg-gray-600 mb-5"/>
                    <Contacts
                        _className="px-3.5 bg-gray-500 flex-grow h-fit md:h-full
                        print:h-fit print:break-inside-avoid
                        "/>
                </div>
